...
class BeaconPluginPage extends StatefulWidget {
  const BeaconPluginPage();

  @override
  _BeaconPluginPageState createState() => _BeaconPluginPageState();
}

class _BeaconPluginPageState extends State<BeaconPluginPage>   with WidgetsBindingObserver {
  ...
  Future<void> initPlatformState() async {
    ...
    await BeaconsPlugin.addRegion(
        "SalaBlanco", "b9407f30-f5f8-466e-aff9-25556b57fe6d");
    await BeaconsPlugin.addRegion(
        "Cuarto", "b9407f30-f5f8-466e-aff9-25556b57fe6a");
